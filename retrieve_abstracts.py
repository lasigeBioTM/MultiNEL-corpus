...
while start <= 23101:
    ...
    # Search parameters: health sciences, case reports, english, portuguese, spanish
    url = 'https://search.scielo.org/?q=*&lang=pt&count=100&from=' + str(start) + '&output=site&sort=&format=summary&page=1&where=&filter[subject_area][]=Health+Sciences&filter[type][]=case-report&filter[la][]=en&filter_boolean_operator[la][]=OR&filter[la][]=pt&filter_boolean_operator[la][]=OR&filter[la][]=es'
            ...
            if abstracts_dict[abstract_id][0][0] in language_list and abstracts_dict[abstract_id][1][0] in language_list and abstracts_dict[abstract_id][2][0] in language_list:
                ...
                for value in abstracts_dict[abstract_id]:
                    ...
                    if value[0] == "en":
                        ...
                        with open('scielo_abstracts/' + value[1], 'w') as en_file:
                            en_ids_count += 1
                        ...
                        with open('scielo_abstracts/' + value[1], 'w') as es_file:
                            es_ids_count += 1
                        ...
                        with open('scielo_abstracts/' + value[1], 'w') as pt_file:
                            pt_ids_count += 1
